<?php 
	...
	*/
	...
	//Inicio las variables cedula, nombres y apellidos
	$cedula="";
	$nombres="";
	$apellidos="";
	$fecha="";
	...
	$mipdf->SetY($y);
	$mipdf->SetX($x);
	$mipdf->Cell (62, 4, "Certificado Electoral: ".$id_certifica, 0, 2, 'L');
	$x=2;
	$mipdf->SetX($x);
	$mipdf->Cell (21, 4, "Cédula: ".$cedula, 0, 0, 'L');
	$x+=23;
	$mipdf->SetX($x);
	$mipdf->Cell (35, 4, "Nombres: ".$nombres, 0, 0, 'L');
	$x+=35;
	$mipdf->SetX($x);
	$mipdf->Cell (35, 4, "Apellidos: ".$apellidos, 0, 2, 'L');
